...
<img src="/prachi/images/${book.imageP}" width="300" height="300">

<div>
</div>

<a href="lend.htm/${book.bookID}">lend</a>
</c:forEach>
</div>

<hr>
   
<button style="width: 200px; align-items:center; margin-left:500px" type="button" class="btn btn-sm btn-outline-secondary"><a href="viewcust.htm">view Book</a></button>   
