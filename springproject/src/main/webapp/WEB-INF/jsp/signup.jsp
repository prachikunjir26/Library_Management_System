...
<main style="background-color: #FEFBE7">
		 ...
		 <form:form modelAttribute="user" method="post" action="adduser.htm">
            	   ...
            	   <br><input style="width: 200px; align-items:center; margin-left:500px" type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" name="UserName" placeholder="Username"><br>
            	   ...
            	   <input style="width: 200px; align-items:center; margin-left:500px" type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" name="userType" placeholder="UserType"><br>
		 ...
		 <button style="width: 200px; align-items:center; margin-left:500px" type="button" class="btn btn-sm btn-outline-secondary"><a href="log.htm">Log In</a></button>
